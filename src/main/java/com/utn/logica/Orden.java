...
Se importan diferentes paquetes para utilizar en la GUI como para imprimir en pantalla y no en consola
 */
...
public class Orden {
    ...
    @Override
    /*
    El método To String de esta clase permite realizar el calculo del descuento y realiza las conversiones de la moneda al total, 
    se muestra el cálculo total y la información de la orden
    */
